...
fontsize=\footnotesize]
    {java}
//Ejemplo de uso de URL con JavaFX
...
public class URLEjemplo extends Application {

    @Override
    public void start(Stage primaryStage) {
        Button btn = new Button("Ir a www.utm.mx");
        btn.setOnAction(e -> {
            getHostServices().showDocument("http://www.utm.mx");
        });
        ...
        primaryStage.setTitle("Ejemplo URL");
...
\end{minted}
\caption{Ejemplo de clase URL con JavaFX.}
% \caption[Long Code Example]{A long code example which will break across pages.}
\label{listing:1}
\end{longlisting}

Este programa muestra una ventana con un botón que, al ser presionado, abre la página web indicada en el navegador predeterminado del sistema.
...
\mint[frame=none,linenos=false]{bash}| \$java NSLookupApp www.utm.mx |
...
\mint[frame=none,linenos=false]{java}| miSocket = new Socket ("mixteco.utm.mx", 1111); |
...
\mint[frame=none,linenos=false]{java}| miServidor = new ServerSocket(1111); |
