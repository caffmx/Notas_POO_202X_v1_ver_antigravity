...
\hline
 \mint[frame=none,linenos=false]{cpp}| assert (int expression)  |\\
\hline
\end{tabular}
\end{center}
...
\mint[frame=none,linenos=false]{cpp}| #define NDEBUG |
...
\rowcolor{gray!50}\textbf{Sintaxis}\\ 
\hline
 \mint[frame=none,linenos=false]{java}| assert Expression1;  |\\
 o \\
 \mint[frame=none,linenos=false]{java}| assert Expression1 : Expression2 ;  |\\
\hline
\end{tabular}
\end{center}
...
\mint[frame=none,linenos=false]{java}| assert ++i < max; |
...
\rowcolor{gray!50}\textbf{Sintaxis}\\ 
\hline
 \mint[frame=none,linenos=false]{python}| assert <expresión> [, ‘mensaje opcional’]  |\\
\hline
\end{tabular}
\end{center}
...
\mint[frame=none,linenos=false]{python}| raise AssertionError() |
...
\mint[frame=none,linenos=false]{bash}| $ python -O |
...
\mint[frame=none,linenos=false]{console}| pytest test_calculadora.py |
