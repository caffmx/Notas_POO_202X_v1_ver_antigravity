...
\item  \textit{Jython}. Es una implementación de Python para ejecutarse en máquinas virtuales de Java (JVM), de manera similar a Scala. Puede hacer uso de la biblioteca de clases de Java. 
...
\subsection{Python estáticamente tipado}
