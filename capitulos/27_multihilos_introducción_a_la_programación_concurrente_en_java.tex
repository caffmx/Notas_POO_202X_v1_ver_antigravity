...
Esta técnica, extiende a la clase \textit{Thread}, y sobreescribe el método \textit{run()}, el cual debe contener un implementación propia, de acuerdo a lo que se quiera que realice el hilo.
...
\item \textit{run()}. Este método se sobreescribe para controlar la ejecución del hilo.
...
Java tiene psobreescritas 3 constantes de prioridad:
