...
\mint[frame=none,linenos=false]{scala}|(1).(((2).*(3))./(x))  |
...
\mint[frame=none,linenos=false]{scala}|array = new Array(2)|
...
\mint[frame=none,linenos=false]{scala}|scala>array(0)=3.23|
...
\mint[frame=none,linenos=false]{scala}| for(i<-1 to 10)println(i) |
