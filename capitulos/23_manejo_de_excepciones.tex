...
\hline
 \mint[frame=none,linenos=false]{cpp}| throw "Se genera una excepción de tipo char *";  |\\
\hline
\end{tabular}
\end{center}
...
\mint[frame=none,linenos=false]{java}| catch (RuntimeException ex) |

o

\mint[frame=none,linenos=false]{java}| catch (Exception ex) |
...
\rowcolor{gray!50}\textbf{Sintaxis}\\ 
\hline
 \mint[frame=none,linenos=false]{ruby}| raise ExceptionClass[, "message"]  |\\
\hline
\end{tabular}
\end{center}
